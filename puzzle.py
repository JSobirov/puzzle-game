...
class window(QWidget):
        ...
        if self.btn1.text()=="1" and self.btn2.text()=="2"and self.btn3.text()=="3" and self.btn4.text()=="4" and self.btn5.text()=="5":
            if self.btn6.text()=="6" and self.btn7.text()=="7" and self.btn8.text()=="8" and self.btn9.text()=="9" and self.btn10.text()=="10":
                if self.btn11.text()=="11" and self.btn12.text()=="12" and self.btn13.text()=="13" and self.btn14.text()=="14" and self.btn15.text()=="15" and self.btn16.text()=="":
                            ...
                            self.msg.setStyleSheet("color:red;font-size:20px")
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("C:\\Users\\User\\Desktop\\3-oy python\\19-dars 22.02.23\\rasim.png"))
        ...
        self.Start.setStyleSheet("background-color:white;color:black;font-size:30px;border-radius:15%;border:4px solid red;")
        self.Start.clicked.connect(self.start1)

        self.Reset = QPushButton('RESET')
        self.Reset.setStyleSheet("background-color:white;color:black;font-size:30px;border-radius:15%;border:4px solid red;")
        self.Reset.clicked.connect(self.reset1)

        self.exit = QPushButton("EXIT")
        self.exit.setStyleSheet("background-color:white;color:black;font-size:30px;border-radius:15%;border:4px solid red;")
